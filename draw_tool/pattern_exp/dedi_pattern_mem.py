...
# python .\dedi_pattern_mem.py '..\log\7-30-3(nginx32_base)\out_mem_usage.log' '..\log\7-30-2(nginx32_uksm)\out_mem_usage.log' '..\log\7-30-1(nginx32_pksm)\out_mem_usage.log'
# python .\dedi_pattern_mem.py '..\log\7-30-6(elastic16_base)\out_mem_usage.log' '..\log\7-30-5(elastic16_uksm)\out_mem_usage.log' '..\log\7-30-4(elastic16_pksm)\out_mem_usage.log'
