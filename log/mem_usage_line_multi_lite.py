...
# ========================== train ==============================
            # if 'CKSM' in lineLabel[i] and (idx == 19 or idx == 18):
            #     Y[i].pop()
            #     X[i].pop()
# ================================================================
# ========================== lapp ==============================
# 41
            # if 'CKSM' in lineLabel[i] and idx in CKSMFilter:
            #     X[i].pop()
            #     Y[i].pop()
            # if 'Base' in lineLabel[i] and idx in BaseFilter:
            #     X[i].pop()
            #     Y[i].pop()
            # if 'UKSM' in lineLabel[i] and idx in UKSMFilter:
            #     X[i].pop()
            #     Y[i].pop()
# ================================================================
# ========================== net ==============================
