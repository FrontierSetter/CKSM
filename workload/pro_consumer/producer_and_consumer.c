...
#define NUM 200 //maximum num of producer_threads or consumer_threads
buffer_item *buffer; //the shared buffer
...
int main(int argc, char *argv[])
{
    ...
    buffer = (int*)malloc(BUFFER_SIZE*sizeof(buffer_item));
    memset(buffer, 128, BUFFER_SIZE*sizeof(buffer_item));
